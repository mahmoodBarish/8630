...
// Define colors
const Color primaryRed = Color(0xFFD83752);
const Color darkGray = Color(0xFF212121);
const Color mediumGray = Color(0xFF717171);
const Color lightGray = Color(0xFFF2F2F2);
const Color white = Colors.white;
const Color semiTransparentLightGray = Color(0x4DFAFAFA); // F2F2F2 with opacity 0.3
const Color transparentBlackBlur = Color(0xE6FFFFFF); // White with opacity 0.9 and blur

// Text Styles (using GoogleFonts for Inter, SF Pro Text is a system font, using Inter as a fallback/alternative if not explicitly added)
final TextStyle darkGrayMedium14 = GoogleFonts.inter(
  fontSize: 14,
  fontWeight: FontWeight.w500,
  color: darkGray,
  letterSpacing: -0.5,
  height: 1.21, // Calculated from lineHeightPx / fontSize
);
...
final TextStyle statusBarTimeStyle = TextStyle(
  fontFamily: 'SF Pro Text', // Placeholder, replace with actual font if available
  fontSize: 16.56,
  fontWeight: FontWeight.w600,
  color: darkGray,
  letterSpacing: -0.55,
  height: 1.33, // Calculated from lineHeightPx / fontSize
);
...
class DisplayCard extends StatefulWidget {
  ...
  final bool isLiked; // To manage heart icon state
  final bool isHeartFilled; // For specific heart icon (filled vs outlined)
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  ...
                  fit: BoxFit.cover,
                  height: 295 * (MediaQuery.of(context).size.width / 375), // Responsive height
                  width: double.infinity,
                ),
              ),
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _isLiked || widget.isHeartFilled
                          ? primaryRed.withOpacity(0.8)
                          : Colors.black.withOpacity(0.1), // Adjusted for better visibility
                    ),
                    child: Icon(
                      _isLiked || widget.isHeartFilled
                          ? Icons.favorite
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: semiTransparentLightGray, // F2F2F2 with 0.3 opacity
            ...
            child: Row(
              ...
              children: [
                ...
                OutlinedButton(
                  onPressed: () {
                    context.push('/details'); // Using go_router
                  },
...
class _MyRedesignScreenState extends State<MyRedesignScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const double heroSectionHeight = 204.0;
    const double bottomNavBarHeight = 88.0;
    const double mapButtonHeight = 33.0;
    const double mapButtonWidth = 74.0;

    return Scaffold(
      backgroundColor: Colors.white, // Figma background for the main screen is white
      body: Stack(
        children: [
          // Scrollable Content Area
          Positioned.fill(
            top: heroSectionHeight, // Start content below the fixed header
              ...
              child: Column(
                ...
                children: [
                  ...
                  DisplayCard(
                    ...
                    dates: 'Jul 2 - 7',
                    pricePerNight: '\$360 / Night',
                    isLiked: false, // Default is outlined heart
                  ),
                  const SizedBox(height: 16),
                  DisplayCard(
                  ...
                  // Additional spacing to ensure last card is not covered by map button
                  const SizedBox(height: mapButtonHeight + 24),
                ],
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: SafeArea(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      // Status Bar placeholder (actual status bar is handled by SafeArea padding)
                      SizedBox(
                        height: MediaQuery.of(context).padding.top > 0 ? 0 : 20, // Adjust height based on SafeArea
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text('9:41', style: statusBarTimeStyle),
                        ),
                      ),
                      const SizedBox(height: 10), // Spacing below status bar
                      // Search Bar
                      Container(
                        height: 55,
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.search, size: 24, color: darkGray),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Where to?',
                                    style: darkGrayMedium14.copyWith(height: 1.57), // 22/14px line height
                                  ),
                                  Text(
                            ...
                            Container(
                              ...
                              child: Icon(Icons.tune, size: 20, color: darkGray),
                            ),
                          ],
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            CategoryItem(
                              iconAssetPath: 'assets/images/I175_156.png', // custom icon asset
                              label: 'OMG!',
                            ...
                            CategoryItem(
                              iconAssetPath: 'assets/images/I175_161.png', // custom icon asset
                              label: 'Beach',
                            ...
                            const SizedBox(width: 16),
                            CategoryItem(
                              iconAssetPath: 'assets/images/I175_165.png', // custom icon asset
                              label: 'Pools',
                            ...
                            const SizedBox(width: 16),
                            CategoryItem(
                              iconAssetPath: 'assets/images/I175_169.png', // custom icon asset
                              label: 'Islands',
                            ...
                            const SizedBox(width: 16),
                            CategoryItem(
                              iconAssetPath: 'assets/images/I175_173.png', // custom icon asset
                              label: 'Islands', // Duplicated label, adjust if needed
          ...
          // Fixed Map Button
          Positioned(
            bottom: bottomNavBarHeight + 16, // Above bottom nav with 16px spacing
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.map, size: 16, color: white),
            ...
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: transparentBlackBlur, // White with 0.9 opacity for the blur effect
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (MediaQuery.of(context).padding.bottom > 0)
                          Padding(
                            padding: EdgeInsets.only(bottom: MediaQuery.of(context).padding.bottom - 5), // Adjust to make it appear within the bottom padding
                            child: Container(
                              width: 134,
                              height: 5,
                              decoration: BoxDecoration(
